    ...
    return (
        <div>
            ...
            <form action="">
                ...
                <label className="" htmlFor=""> Empresa*
                ...
                <select name="setor">
                    ...
                    <option value="telemarketing-atendimendo">Telemarketing e Atendimento ao Cliente</option>
                ...
                <label className="" htmlFor=""> Site da Empresa*
                    <input className="" type="text" />
                </label>

                <label className="" htmlFor=""> Responsabilidades*
                    <input className="" type="text" />
                </label>

                <label className="" htmlFor=""> Cargo*
                    <input className="" type="text" />
                </label>
