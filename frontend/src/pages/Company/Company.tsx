        ...
        <div className="company">
            ...
            <div className="company__list">
                <ul>
                    ...
                    <li className="company__description">A toti é a primeira plataforma brasileira de ensino e inculsão de pessoas refugiadas e migrantes no mercado
                de trabalho de tecnologia.</li>
                </ul>
            </div>
