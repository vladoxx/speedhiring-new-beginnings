    ...
    return (
        <div className="formation">
            <form action="">
                ...
                <label className="formation__institution" htmlFor="">Institução*
                    <input className="formation__institution_select" type="text" required />
                </label>
                <label className="formation__course" htmlFor="">Curso*
                    <input className="formation__course_name" type="text" required />
                </label>
                <label className="formation__start_date" htmlFor="">Inicio*
                    <input className="fformation__start_date_select" type="text" placeholder="01/2011" required />
                </label>
                <label className="formation__end_date" htmlFor="">Previsão/Data de Conclusão*
